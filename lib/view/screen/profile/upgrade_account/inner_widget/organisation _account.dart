...
class OrganisationAccount extends StatefulWidget {
  ...
  @override
  State<OrganisationAccount> createState() => _OrganisationAccountState();
}

class _OrganisationAccountState extends State<OrganisationAccount> {
        ...
        children: [
          ...
          Container(
            ...
            child: Row(
              ...
              children: [
                GestureDetector(
                  onTap: () => controller.selectOrganisationPackage(0),
                  child: Container(
                    decoration: BoxDecoration(
                        color: controller.organisationAccountPackage == 0
                ...
                GestureDetector(
                  onTap: () => controller.selectOrganisationPackage(1),
                  child: Container(
                    decoration: BoxDecoration(
                      color:
                      controller.organisationAccountPackage == 1 ? AppColors.primaryColor : AppColors.grey300,
                    ),
                    padding:
                    EdgeInsets.symmetric(horizontal: 12.w, vertical: 4.h),
                    child: const Column(
                ...
                GestureDetector(
                  onTap: () => controller.selectOrganisationPackage(2),
                  child: Container(
                    decoration: BoxDecoration(
                        color: controller.organisationAccountPackage == 2
                            ? AppColors.primaryColor
                            : AppColors.grey300,
                        borderRadius: BorderRadius.only(
