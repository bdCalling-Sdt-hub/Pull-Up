class MyEventHistoryModel {
  bool? success;
  String? message;
  List<Data>? data;

  MyEventHistoryModel({this.success, this.message, this.data});

  MyEventHistoryModel.fromJson(Map<String, dynamic> json) {
...
class Data {
  ...
  Data({this.sId, this.userId, this.eventId});
